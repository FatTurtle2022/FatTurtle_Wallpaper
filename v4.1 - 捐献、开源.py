...
juanxian_Button = tk.Button(window,text='捐献', width=20, height=2, command=juanxian)
juanxian_Button.place(x=10, y=400)

def kaiyuan():
    os.system('start https://github.com/FatTurtle2022/FatTurtle_Wallpaper/releases')

kaiyuan_Button = tk.Button(window,text='开源', width=20, height=2, command=kaiyuan)
kaiyuan_Button.place(x=10, y=450)
